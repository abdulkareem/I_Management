-- Internship ownership + visibility + dynamic vacancy fields
...
CREATE INDEX IF NOT EXISTS idx_internships_created_by_visibility
  ON internships(created_by, visibility_type, is_external, status);
