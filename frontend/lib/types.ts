...
export interface IPODashboard {
  ...
  applications?: Array<{ id: string; studentName: string; studentEmail?: string | null; collegeName: string; opportunityTitle: string; status: string; createdAt?: string; completedAt?: string | null; ipoFeedback?: string | null; ipoScore?: number | null }>;
