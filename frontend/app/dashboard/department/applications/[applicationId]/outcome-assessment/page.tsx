...
export default function DepartmentApplicationOutcomeAssessmentPage() {
  ...
  async function onSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    setError(null);
    try {
      await fetchWithSession(`/api/department/applications/${params.applicationId}/outcome-assessment`, {
        method: 'POST',
        body: JSON.stringify({
