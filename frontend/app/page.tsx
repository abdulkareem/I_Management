...
const rolePortals = [
  {
    ...
    summary:
      "Approve internships, monitor compliance, manage students, verify reports, and watch subscription usage.",
  },
  {
    ...
    summary:
      "Apply for internships, upload logbooks, submit reports, track attendance, and receive approval alerts.",
  },
  {
    ...
    summary:
      "Publish slots, sign MoUs, verify student attendance, upload certificates, and manage college partnerships.",
  },
  {
    ...
    summary:
      "Monitor memory usage, pricing, onboarding, platform-wide registrations, billing, and storage-heavy tenants.",
  },
];

const quickLinks = [
  { label: "Student portal", href: "/portal/student" },
  { label: "College portal", href: "/portal/college" },
  { label: "Industry portal", href: "/portal/industry" },
  { label: "Super admin portal", href: "/portal/super-admin" },
];
...
const headlineMetrics = [
  {
    ...
    value: "48",
    detail: "Multi-tenant onboarding with isolated data and billing.",
  },
  {
    label: "Industries registered",
    value: "326",
    detail: "Shared network mapped to college-specific MoUs.",
  },
  {
    label: "Students registered",
    value: "18,240",
    detail: "Students, logbooks, reports, attendance, and certificates.",
  },
  {
    label: "Storage billable this month",
    value: "412 GB",
    detail: "Documents, student records, and industry uploads.",
  },
];
...
const pricingPlans = [
  ...
  },
  {
    ...
    description:
      "For colleges that need workflow automation and stronger reporting.",
    inclusions: [
      "Attendance + logbooks",
      "AI matching support",
      "Payment tracking",
      "Storage analytics for billing",
    ],
  },
  {
    tier: "Enterprise",
...
const deploymentChecklist = [
  ...
  "Deploy only static files generated by next build",
];
  ...
  return (
    <main>
      <header className="panel top-nav">
        <div>
          <span className="badge">PRISM deployment-ready frontend</span>
          <p className="lead compact nav-copy">
            Static-exported Next.js application for Cloudflare Pages with direct
            links to every portal.
          </p>
        </div>
        <nav className="nav-links" aria-label="Primary portal navigation">
          {quickLinks.map((link) => (
      ...
      <section className="hero hero-grid">
        <div className="panel hero-panel">
          <span className="badge">
            Separated deployment • Frontend on Cloudflare Pages • Backend on
            Railway
          </span>
          <h1>
            One public PRISM website. Separate dashboards for colleges,
            students, industries, and super admin.
          </h1>
          <p className="lead">
            Launch a single platform entry point where every user logs in from
            the same homepage, while your codebase is clearly separated into
            dedicated <strong>frontend</strong> and <strong>backend</strong>{" "}
            directories for deployment and maintenance.
          </p>

          <div className="pill-row">
            <span className="pill">Common login + register entry</span>
            <span className="pill">
              College, student, industry, super-admin portals
            </span>
        ...
        <aside className="panel spotlight-panel">
          ...
          <div className="kpi-list">
            ...
            <div className="kpi-item">
              ...
              <strong>
                {getMinimumRequiredHours("BA")}h default /{" "}
                {getMinimumRequiredHours("BBA")}h BBA-BCA
              </strong>
            </div>
          </div>
        </aside>
        ...
        <div className="section-heading-row">
          <div>
            <h2 className="section-title">
              Shared entry website with role-based dashboard access
            </h2>
            <p className="lead compact">
              This homepage acts as the common entry point for colleges,
              students, industry partners, and the super admin. Each role can
              log in or register from one place and enter its own dashboard.
            </p>
          </div>
      ...
      <section className="panel section-block">
        <div className="section-heading-row">
          <div>
            ...
            <p className="lead compact">
              Use the frontend directory as the project root in Cloudflare Pages
              so the static export lands in the generated <strong>out</strong>{" "}
              folder.
            </p>
          </div>
          <span className="table-highlight">
            Zero-runtime static deployment
          </span>
        </div>

        <div className="stats deployment-grid top-gap">
      ...
      <section className="panel section-block">
        <div className="section-heading-row">
          <div>
            <h2 className="section-title">
              Storage usage dashboard for super admin billing
            </h2>
            <p className="lead compact">
              Usage includes registered colleges, their student data, associated
              industries, and all uploaded documents such as MoUs, certificates,
              reports, attendance files, and verification attachments.
            </p>
          </div>
      ...
      <section className="grid-3">
        <article className="panel section-block">
          ...
          <ul className="feature-list">
            <li>
              Major, minor, interdisciplinary, and allied internship tagging.
            </li>
        ...
        <article className="panel section-block">
          ...
          <p className="detail">
            ...
            {reportTemplate.supportedLanguages.join(" and ")}.
          </p>
        </article>
      </section>

      <footer>
        PRISM now keeps deployment-ready code in dedicated{" "}
        <strong>frontend</strong> and <strong>backend</strong> directories while
        preserving the shared packages workspace for types, compliance, and
        database models.
      </footer>
    </main>
  );
